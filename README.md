...
<head>
 ...
 <style>
        .botao-itchio {
            background-color: #fa5c5c; /* Cor clássica do itch.io */
            color: white;
            padding: 10px 20px;
...
<n0> <span style="color:blue" class="plataformas-etc"> plaformas e sites relacionados </n0>


<img src="capa.jpeg" type="jpeg/png"></img>
